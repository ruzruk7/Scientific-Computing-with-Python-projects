...
# this project was made using no refrences, I am sure there are more efficient ways to do this in terms of runtime. But given my current knowledge I got here by myself. 
def add_time(time, add_time, day=None):
